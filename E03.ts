namespace E03 {
    ...
    var wolkenPosX: number[] = [];
    var wolkenPosY: number[] = [];

    var schneePosX: number[] = [];
    var schneePosY: number[] = [];
    var hintergrund: ImageData;
    function init(): void {
    ...
    function drawMountain(x: number, y: number) {
        crc2.beginPath();
        crc2.moveTo(x, y);
    ...
    function drawSki(x: number, y: number) {
        crc2.beginPath();
